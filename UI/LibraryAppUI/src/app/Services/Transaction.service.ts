...
export class Transaction {
    ...
    public returnBook(bookTransaction: BookTransaction) {
        ...
        return this.http.put(this.url+'BookTransaction' + '/ReturnBook',bookTransaction).map((res: any) => {
    ...
    public renewBook(bookTransaction: BookTransaction) {
        ...
        return this.http.put(this.url + 'BookTransaction' + '/RenewBook',bookTransaction).map((res: any) => {
